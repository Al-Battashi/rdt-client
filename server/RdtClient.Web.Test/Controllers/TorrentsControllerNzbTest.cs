...
public class TorrentsControllerNzbTest
{
    ...
    {
        _torrentsMock = new(null!, null!, null!, null!, null!, null!, null!, null!, null!, null!, null!, null!, null!, new TestSettings(), new TorrentRunnerState(), new QbittorrentFallbackClient(Mock.Of<ILogger<QbittorrentFallbackClient>>()));
        _loggerMock = new();
